...
//    echo $this->Form->end(array('label' =>__d('acl', 'filter'), 'div' => false));
    ...
    <table border="0" cellpadding="5" cellspacing="2">
        <tr>
            ...
            $headers = array($this->Paginator->sort(__d('acl', 'user'), 'Usuario'));
        ...
        foreach ($users as $user) {
            ...
            $title = __d('acl', 'Administrar privilegios de usuario');
        ...
        <?php echo $this->Paginator->prev('<< ' . __d('acl', 'anterior'), array(), null, array('class' => 'disabled')); ?>
                ...
                |
                <?php echo $this->Paginator->next(__d('acl', 'siguiente') . ' >>', array(), null, array('class' => 'disabled')); ?>
            </td>
        </tr>
    </table>
    <?php
    ...
    foreach ($roles as $role) {
        ...
        if ($role[$role_model_name][$role_pk_name] == $user[$user_model_name][$role_fk_name]) {
            ...
            $title = __d('acl', 'Actualizar el grupo del usuario');
