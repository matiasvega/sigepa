...
<tr>
	...
	$headers = array($this->Paginator->sort($user_display_field, __d('acl', 'Usuario')));
...
?>
    ...
    <p class="warning"><?php echo __d('acl', 'Algunos usuarios no estan asignados a grupos, asignelos a uno.') ?></p>
