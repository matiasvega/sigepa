...
INSERT INTO `backups` VALUES (1,'Full backup SIGEPA 19-11-2014','2014-11-19','backupSigepa_19_11_2014_01_33_39.sql','2014-11-19 01:33:39','2014-11-19 01:33:39'),(2,'Full backup SIGEPA 19-11-2014','2014-11-19','backupSigepa_19_11_2014_01_40_32.sql','2014-11-19 01:40:32','2014-11-19 01:40:32'),(3,'Full backup SIGEPA 19-11-2014','2014-11-19','backupSigepa_19_11_2014_01_41_10.sql','2014-11-19 01:41:10','2014-11-19 01:41:10'),(4,'Full backup SIGEPA 19-11-2014','2014-11-19','backupSigepa_19_11_2014_01_41_21.sql','2014-11-19 01:41:21','2014-11-19 01:41:21'),(5,'Full backup SIGEPA 19-11-2014','2014-11-19','backupSigepa_19_11_2014_01_42_21.sql','2014-11-19 01:42:21','2014-11-19 01:42:21'),(6,'Full backup SIGEPA 19-11-2014','2014-11-19','backupSigepa_19_11_2014_02_10_12.sql','2014-11-19 02:10:12','2014-11-19 02:10:12');
...
INSERT INTO `estudios_complementarios_pacientes` VALUES (1,1,1,NULL,NULL,'2014-09-13',NULL,'2014-09-13 21:13:22','2014-09-13 21:13:22');
...
INSERT INTO `obras_sociales_pacientes` VALUES (1,2,1,NULL,NULL,NULL);
...
INSERT INTO `pacientes` VALUES (1,31220356,'Matias Ariel','Vega Tapia','M','1984-11-10','','154006845','','2014-09-13',NULL,NULL,NULL,NULL,NULL,'2014-09-13 21:07:30','2014-09-13 21:13:22'),(2,0,'Carla Fabiana','Casta̱o Li̱eiro','F','1984-11-05','','154613465','','2014-11-17','aaaaaaaaaaaaaaaaaaaaaa','','','','','2014-09-13 21:09:34','2014-11-17 11:40:49');
...
CREATE TABLE `turnos` (
  ...
  CONSTRAINT `fk_turnos_especialidades1` FOREIGN KEY (`especialidades_id`) REFERENCES `especialidades` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_turnos_pacientes1` FOREIGN KEY (`pacientes_id`) REFERENCES `pacientes` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_turnos_profesionales1` FOREIGN KEY (`profesionales_id`) REFERENCES `profesionales` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
-- Dump completed on 2014-11-18 23:13:54
